...
interface MedicalProBranding {
  data: { title: string; desc: string }[];
  teams: { name: string; color: string }[];
  leaders: { image: string }[];
}
...
export const kanbanGrid: KanbanGridItem[] = [
...
export const areaCustomSeries: ChartSeries[] = [
  {
...
export const barCustomSeries: ChartSeries[] = [
  {
...
export const customersGrid: GridColumn[] = [
...
export const employeesGrid: GridColumn[] = [
  {
    headerText: "Employee",
    width: "150",
...
export const earningData: EarningItem[] = [
  {
...
export const recentTransactions: RecentTransactionItem[] = [
  {
...
export const weeklyStats: WeeklyStatItem[] = [
  {
    icon: <FiShoppingCart />,
    amount: "-$560",
    title: "Top Sales",
...
export const productsPerformance: ProductPerformanceItem[] = [
  {
    image: product5,
...
export const userProfileData: UserProfileDataItem[] = [
  {
    icon: <BsCurrencyDollar />,
    title: "My Profile",
...
export const ordersGrid: GridColumn[] = [
  {
    headerText: "Image",
...
export const lineCustomSeries: ChartSeries[] = [
  {
...
export const ecomPieChartData: ChartDataPoint[] = [
  { x: "2018", y: 18, text: "35%" },
  { x: "2019", y: 18, text: "15%" },
  { x: "2020", y: 18, text: "25%" },
  { x: "2021", y: 18, text: "25%" },
...
export const stackedChartData: ChartDataPoint[][] = [
  [
    { x: "Jan", y: 111.1 },
    { x: "Feb", y: 127.3 },
    { x: "Mar", y: 143.4 },
...
export const stackedCustomSeries: ChartSeries[] = [
  {
...
export const kanbanData: KanbanDataItem[] = [
  {
    Id: "Task 1",
    Title: "Task - 29001",
    Status: "Open",
...
export const financialChartData: FinancialChartDataPoint[] = [
  {
...
export const PyramidData: ChartDataPoint[] = [
